<div class="container-md text-light">
    ...
    <?php foreach ($mangas as $manga): ?>
        ...
        <div class="row justify-content-center">
            ...
            <div class="card mb-3 p-0 shadow" style="max-width: 540px;">
                <a href="<?= BASE_URL ?>/manga/detalhe/<?= $manga->getId() ?>" class="text-decoration-none text-dark">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img class="img-fluid rounded-start" src="<?="../" . $manga->getImagem() ?>"
                                alt="Preview da capa">
                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <p class="card-text fs-4 fw-bold text-success mb-0">R$<?= $manga->getPrecoFormatado() ?>
                                    </p>
